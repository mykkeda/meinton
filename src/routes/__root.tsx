...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Julian Blumnauer – Produzent, Tontechniker und Musiker aus Kaiserslautern. Mixing, Recording und Musikproduktion." },
      { property: "og:title", content: "Julian Blumnauer – Mixing, Recording, Musikproduktion" },
      { property: "og:description", content: "Produzent, Tontechniker und Musiker aus Kaiserslautern." },
